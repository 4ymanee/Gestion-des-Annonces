        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrixNegociable = table.Column<bool>(type: "bit", nullable: false),
                    Etat = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Ville = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    ModeTransaction = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medias_Annonces_AnnonceId",
                        column: x => x.AnnonceId,
                        principalTable: "Annonces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Maisons, appartements, terrains...", "Immobilier" },
                    { 2, "Voitures, motos, utilitaires...", "Véhicules" },
                    { 3, "Téléphones, ordinateurs, consoles...", "Électronique" },
                    { 4, "Mobilier, bricolage, décoration...", "Maison et Jardin" },
                    { 5, "Vêtements, chaussures, bijoux...", "Mode et Accessoires" },
                    { 6, "Sport, musique, jeux, livres...", "Sports et Loisirs" }
                });
